...
//  navAndViews
//
//  Created by John Boyd on 4/25/15.
...
-(CGMutablePathRef)makeAPath
{
    ...
    CGPoint s[arraySize] = {111, 204, 181, 300, 111, 395, 0, 358, 0, 241, 111, 204};
...
-(void)drawPathAnimated
{
    ...
    pathAnimation2.toValue = (__bridge id)([UIColor redColor].CGColor);
